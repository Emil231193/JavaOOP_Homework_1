public class Spearman extends Creature {
    public Spearman(String name, int body, int agility, int intelligence, int treatment, int oblivion) {
        super(name, body, agility, intelligence, treatment, oblivion);
        this.weapon = new Weapon("Копье", 18);
        this.clothes = new Cloth("Средняя броня", 25);
    }
    @Override
